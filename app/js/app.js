...
$(function(){
	...
	if($('html.mobile').length && $('.home[role=main]').length){
		// TweenMax.set('body, html', {scrollTop: $('.menu').offset().top - $('h1').height()});
		// TweenMax.to('body, html', 0.5, {
		// 	scrollTop: $('.menu').offset().top - $('h1').height(),
		// 	onComplete: function (){
		// 		TweenMax.to('body, html', 0.5, {
		// 			delay: 1,
		// 			scrollTop: 0.4 * $(window).height()
		// 		});
		// 	}
		// });
	}
